...
Route::post('/create', [\App\Http\Controllers\PractiseReport\CreateController::class, 'createPractiseReport']);
Route::get('/{id}/get', [\App\Http\Controllers\PractiseReport\GetController::class, 'getPractiseReportById']);
Route::get('/getAll', [\App\Http\Controllers\PractiseReport\GetController::class, 'getAllPractiseReports']);
Route::post('/{id}/edit', [\App\Http\Controllers\PractiseReport\EditController::class, 'updatePractiseReport']);
Route::post('/{id}/delete', [\App\Http\Controllers\PractiseReport\DeleteController::class, 'deletePractiseReport']);
